...
class Settings:
    ...
    # Retriever (MMR)
    search_type: str = st.session_state.search_type      # "mmr" o "similarity"
    k: int = st.session_state.k                          # risultati finali
    fetch_k: int = 1                                        # candidati iniziali (per MMR)
    mmr_lambda: float = st.session_state.mmr_value      # 0 = diversificazione massima, 1 = pertinenza massima
    # Embedding
